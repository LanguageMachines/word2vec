...
#define MAX_STRING 100 // longest word we handle
...
char train_file[FILENAME_MAX], output_file[FILENAME_MAX];
char save_vocab_file[FILENAME_MAX], read_vocab_file[FILENAME_MAX];
